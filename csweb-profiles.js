...
(function () {
  ...
  // 1b. BAURANSKYY: wszystkie skiny z katalogu (raz, potem bez przeladowan)
  function unlockAll() {
  ...
  function ui() {
    ...
    wrap.innerHTML = '<button id="csweb-profBtn"></button><div id="csweb-panel">'
      ...
      + '<div class="row"><input id="csweb-nick" maxlength="20" placeholder="twoj nick"></div>'
